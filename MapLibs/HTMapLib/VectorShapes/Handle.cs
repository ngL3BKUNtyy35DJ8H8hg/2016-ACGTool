...
namespace HTMapLib
{
    ...
    public abstract class AbstractSel : Ele
    {
        ...
        public string isOver(int x, int y)
        {
            ...
            if (this.contains(x, y))
                return "C"; //HT Note: Move đối tượng shape

            return "NO"; //HT Note: Không làm gì đối tượng shape
    ...
    public class SelPoly : AbstractSel
    {
        ...
        {
            this.handles.Add(new NewPointHandle(this, "NEWP", newP, this.handles.Count));
        }
