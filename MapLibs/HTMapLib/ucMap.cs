...
namespace HTMapLib
{
    ...
    public partial class ucMap : UserControl
    {
        ...
        public void axMap1_MouseDownEvent(object sender, AxMapXLib.CMapXEvents_MouseDownEvent e)
        {
            ...
            if (ActiveToolStrip == enumToolStripType.ActionToolStrip && AxMapAction_MouseDownEvent != null)
                AxMapAction_MouseDownEvent(sender, e);

            if (ActiveToolStrip == enumToolStripType.DrawingToolStrip && AxMapDrawing_MouseDownEvent != null)
                AxMapDrawing_MouseDownEvent(sender, e);

            //if (ActiveToolStrip == enumToolStripType.VectorShapeToolStrip)
        ...
        public void axMap1_MouseMoveEvent(object sender, AxMapXLib.CMapXEvents_MouseMoveEvent e)
        {
            ...
            if (ActiveToolStrip == enumToolStripType.ActionToolStrip && AxMapAction_MouseMoveEvent != null)
                AxMapAction_MouseMoveEvent(sender, e);

            if (ActiveToolStrip == enumToolStripType.DrawingToolStrip && AxMapDrawing_MouseMoveEvent != null)
        ...
        public void axMap1_MouseUpEvent(object sender, AxMapXLib.CMapXEvents_MouseUpEvent e)
        {
            ...
            if (ActiveToolStrip == enumToolStripType.ActionToolStrip && AxMapAction_MouseUpEvent != null)
                AxMapAction_MouseUpEvent(sender, e);

            if (ActiveToolStrip == enumToolStripType.DrawingToolStrip && AxMapDrawing_MouseUpEvent != null)
        ...
        public void axMap1_MouseWheelEvent(object sender, AxMapXLib.CMapXEvents_MouseWheelEvent e)
        {
            ...
            if (ActiveToolStrip == enumToolStripType.ActionToolStrip && AxMapAction_MouseWheelEvent != null)
                AxMapAction_MouseWheelEvent(sender, e);

            if (ActiveToolStrip == enumToolStripType.DrawingToolStrip && AxMapDrawing_MouseWheelEvent != null)
        ...
        public void axMap1_MapViewChanged(object sender, EventArgs e)
        {
            ...
            if (ActiveToolStrip == enumToolStripType.ActionToolStrip && AxMapAction_MapViewChanged != null)
                AxMapAction_MapViewChanged(sender, e);

            if (ActiveToolStrip == enumToolStripType.DrawingToolStrip && AxMapDrawing_MapViewChanged != null)
        ...
        public void axMap1_DblClick(object sender, EventArgs e)
        {
            ...
            if (ActiveToolStrip == enumToolStripType.ActionToolStrip && AxMapAction_DblClick != null)
                AxMapAction_DblClick(sender, e);

            if (ActiveToolStrip == enumToolStripType.DrawingToolStrip && AxMapDrawing_DblClick != null)
