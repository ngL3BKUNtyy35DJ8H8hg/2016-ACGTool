...
namespace HTMapLib
{
    ...
    {
        private ucVectShapes s;

        public ucVectShapeToolBox(ucVectShapes inS)
        {
            InitializeComponent();
            myInit();
            this.s = inS;
        ...
        private void SelectBtn_Click(object sender, EventArgs e)
        {
            ...
            this.s.Option = enumOption.SELECT;
            //this.s.ucMap1.Map.CurrentTool = MapXLib.ToolConstants.miArrowTool;
            //this.s.ucMap1.ActiveToolStrip = enumToolStripType.VectorShapeToolStrip;
            this.s.ChangeCursor();
        }
        ...
        {
            deselectAll();
            //Đánh dấu chọn nút vẽ Rect
            RectBtn.Checked = true;
            //this.s.Option = "DR";
            this.s.Option = enumOption.DR;
            //this.s.ucMap1.Map.CurrentTool = MapXLib.ToolConstants.miArrowTool;
            //this.s.ucMap1.ActiveToolStrip = enumToolStripType.VectorShapeToolStrip;
            this.s.ChangeCursor();
        }
        ...
        private void GraphBtn_Click(object sender, EventArgs e)
        {
            ...
            //this.s.Option = "GRAPH";
            this.s.Option = enumOption.GRAPH;
            //this.s.ucMap1.Map.CurrentTool = MapXLib.ToolConstants.miArrowTool;
            //this.s.ucMap1.ActiveToolStrip = enumToolStripType.VectorShapeToolStrip;
            this.s.ChangeCursor();
        ...
        {
            deselectAll();
            NewPolyBtn.Checked = true;
            this.s.Option = enumOption.NEWPOLY;
            //this.s.ucMap1.Map.CurrentTool = MapXLib.ToolConstants.miArrowTool;
            //this.s.ucMap1.ActiveToolStrip = enumToolStripType.VectorShapeToolStrip;
            this.s.ChangeCursor();
        }
