...
namespace MITI
{
    public class BaseDBCe2
    {
        private SqlCeConnection sqlConnect;
        public string g_ConnectStr = "";     //Connect String
        public SqlCeDataAdapter g_SqlCeDataAdapter;

        public BaseDBCe2(string connectStr)
        {
            g_ConnectStr = string.Format("DataSource={0}; Password=''", connectStr);
        }
        ...
        public string GetParamPlaceHolder(string paramName, bool bAddComma)
        {
        ...
        public SqlCeParameter CreateParameter(ref SqlCeCommand cmd, string paramName, DbType dbType, object value)
        {
        ...
        public SqlCeCommand CreateCommand(string procedureName, params SqlCeParameter[] par)
        {
        ...
        public SqlCeCommand ExecSqlProcedure_Command(string procedureName, params SqlCeParameter[] par)
        {
            SqlCeCommand cmd;
        ...
        public SqlCeCommand ExecSqlProcedure_Command(string procedureName)
        {
            SqlCeCommand cmd;
        ...
        public long ExecSqlProcedure_NoneQuery(string procedureName, params SqlCeParameter[] par)
        {
        ...
        public DataSet ExecSqlProcedure_DataSet(string procedureName, params SqlCeParameter[] par)
        {
            SqlCeCommand cmd;
            cmd = CreateCommand(procedureName,par);
        ...
        public DataSet ExecSqlProcedure_DataSet(string procedureName)
        {
            SqlCeCommand cmd;
            cmd = CreateCommand(procedureName);
             g_SqlCeDataAdapter = new SqlCeDataAdapter(cmd);
        ...
        public SqlCeDataReader ExecSqlProcedure_DataReader(string procedureName, params SqlCeParameter[] par)
        {
            SqlCeCommand cmd;
            cmd = CreateCommand(procedureName, par);
        ...
        public object ExecSqlProcedure_DataValue(string procedureName, params SqlCeParameter[] par)
        {
            SqlCeCommand cmd = null;
            object result;
            try
        ...
        /// the name of a stored procedure.</param>
        /// <returns>An <see cref="SqlCeCommand"/> object.</returns>
        public SqlCeCommand CreateCommand(string sqlText, CommandType type)
        {
            SqlCeCommand cmd = new SqlCeCommand();
            try
            {
        ...
        public long ExecSql_NoneQuery(string strSql)
        {
            SqlCeCommand cmd = null;
            long lRowsAffected = 0;
            try
        ...
        public SqlCeDataReader ExecSql_DataReader(string strSql)
        {
            SqlCeDataReader myReader;
            try
            {
        ...
        public SqlCeResultSet ExecSql_GetTable(string tableName)
        {
            SqlCeCommand cmd = null;
            SqlCeResultSet rs;
            try
        ...
        public SqlCeDataAdapter ExecSql_SqlCeDataAdapter(string strSql)
        {
            SqlCeCommand cmd = null;
            try
            {
        ...
        public DataSet ExecSql_DataSet(string strSql)
        {
            SqlCeCommand cmd = null;
            DataSet ds = new DataSet();
            try
        ...
        /// </summary>
        /// <param name="ds"></param>
        public void ExecSql_UpdateDataSet(DataSet ds)
        {
            try
            {
        ...
        public object ExecSql_DataValue(string strSql)
        {
            SqlCeCommand cmd = null;
            object result;
            try
