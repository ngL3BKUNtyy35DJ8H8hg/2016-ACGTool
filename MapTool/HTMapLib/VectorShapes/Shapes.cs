...
namespace HTMapLib
{
    ...
    public class VectShapeOptionEventArgs : EventArgs
    {
        ...
        //
        //public OptionEventArgs(string s) 
        public VectShapeOptionEventArgs(enumOption s)
        {
            this.option = s;
        }
    }
    ...
    public class MapShapes
    {
        ...
        public MapShapes(float dpix,float dpiy)
        {
            List = new ArrayList();
            initUndoBuff();
                    Ele.dpix = dpix;
        ...
        public void multiSelect(int startX, int startY, int endX, int endY, RichTextBox r)
        {
            ...
            if (selEle != null)
            {
                ...
                //sRec.sonoUnaLinea = selEle.sonoUnaLinea;//indico se il gestore è per una linea
