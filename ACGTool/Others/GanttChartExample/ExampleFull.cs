...
namespace Braincase.GanttChart
{
    ...
    public partial class ExampleFull : Form
    {
        ...
        public ExampleFull()
        {
            ...
            _mManager.Split(pack, new MyTask(_mManager), new MyTask(_mManager), 4);
        ...
        private void mnuViewDayOfWeek_Click(object sender, EventArgs e)
        {
            ...
            dayOfYearToolStripMenuItem.Checked = false;
        ...
        private void dayOfYearToolStripMenuItem_Click(object sender, EventArgs e)
        {
            _mChart.TimeScaleDisplay = TimeScaleDisplay.DayOfYear;
            mnuViewDayOfWeek.Checked = false;
            mnuViewDayOfMonth.Checked = false;
            dayOfYearToolStripMenuItem.Checked = true;
            mnuViewWeekOfYear.Checked = false;
            _mChart.Invalidate();
        }
