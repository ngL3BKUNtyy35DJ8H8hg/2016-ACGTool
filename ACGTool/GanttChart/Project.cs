...
namespace Braincase.GanttChart
{
        ...
        where R : class
    {
        ...
        //    get
        //    {
        //        Dictionary<float, List<T>> endtimelookp = new Dictionary<float, List<T>>(1024);
        //        List<T> list;
        //        var max_end = float.MinValue;
        ...
        public void Relate(T precedent, T dependant)
        {
                ...
                )
            {
                ...
                && !this.DependantsOf(dependant).Contains(precedent))
                {
                    ...
                    //HT Code: Bỏ vẽ task theo ràng buộc precedent phải nằm trước dependant
        ...
        /// </summary>
        public void SetStart(T task, float value)
        {
        ...
        /// </summary>
        public void SetEnd(T task, float value)
        {
        ...
        public void SetDuration(T task, float duration)
        {
        ...
        public void Split(T task, T part1, T part2, float duration)
        {
            if (task != null
                && part1 != null
                && part2 != null
        ...
        /// <param name="duration">The duration of part (1) will be set to the specified duration value but will also be adjusted to approperiate value if necessary.</param>
        public void Split(T part, T other, float duration)
        {
            if (part != null
                && other != null
        ...
        private void _SetStartHelper(T task, float value)
        {
            if (task.Start != value)
            {
        ...
        private void _SetEndHelper(T task, float value)
        {
            if (task.End != value)
            {
                if (_mSplitTaskOfPart.ContainsKey(task))
        ...
        private void _SetPartStartHelper(T part, float value)
        {
        ...
        private void _SetPartEndHelper(T part, float value)
        {
            var split = _mSplitTaskOfPart[part];
            var parts = _mSplitTasks[split];
