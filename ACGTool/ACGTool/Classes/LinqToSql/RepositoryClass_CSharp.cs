...
{
    public class RepositoryClass_CSharp : RepositoryClass
    {
        public RepositoryClass_CSharp(string dbName, DataTable db) : base(dbName, db)
        {
        ...
        public override string InitClass()
        {
            ...
            //Add Class Info
            initCode += "\nPublic Class " + _dbName.ToUpper().Remove(0, 3) + "Info" + "\n\n";
